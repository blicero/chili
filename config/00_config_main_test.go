// /home/krylon/go/src/github.com/blicero/chili/config/00_config_main_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 15. 06. 2026 by Benjamin Walkenhorst
// (c) 2026 Benjamin Walkenhorst
// Time-stamp: <2026-08-12 12:47:44 krylon>
...
func TestMain(m *testing.M) {
	var (
		err     error
		result  int
		baseDir = time.Now().Format("/tmp/chili_cfg_test_20060102_150405")
	)
