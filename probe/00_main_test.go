// /home/krylon/go/src/github.com/blicero/chili/probe/00_main_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 10. 08. 2026 by Benjamin Walkenhorst
// (c) 2026 Benjamin Walkenhorst
// Time-stamp: <2026-08-10 12:28:49 krylon>
...
func TestMain(m *testing.M) {
	var (
		err     error
		result  int
		baseDir = time.Now().Format("/tmp/chili_probe_test_20060102_150405")
	)
